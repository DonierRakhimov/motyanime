...
const genresSlice = createSlice({
  ...
  reducers: {
    ...
    genreRemoved(state, action) {
      state.currentGenres = state.currentGenres.filter((genre) => genre !== action.payload)
    },
...
export const { genreAdded, genreRemoved, currentGenresReplaced } = genresSlice.actions;
